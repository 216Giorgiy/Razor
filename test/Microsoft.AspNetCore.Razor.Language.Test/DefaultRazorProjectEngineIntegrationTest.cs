...
namespace Microsoft.AspNetCore.Razor.Language
{
    public class DefaultRazorProjectEngineIntegrationTest
    {
        ...
        [Fact]
        public void Process_WithTagHelpers_SetsOnCodeDocument()
        {
            // Arrange
            var projectItem = new TestRazorProjectItem("Index.cshtml");
            ...
            // Act
            var codeDocument = projectEngine.Process(projectItem, expectedTagHelpers);
        ...
        public void Process_WithNullTagHelpers_SetsOnCodeDocument()
        {
            ...
            // Act
            var codeDocument = projectEngine.Process(projectItem, tagHelpers: null);
        ...
        [Fact]
        public void ProcessDesignTime_WithTagHelpers_SetsOnCodeDocument()
        {
            // Arrange
            var projectItem = new TestRazorProjectItem("Index.cshtml");
            var expectedTagHelpers = new[]
            ...
            // Act
            var codeDocument = projectEngine.ProcessDesignTime(projectItem, expectedTagHelpers);
        ...
        public void ProcessDesignTime_WithNullTagHelpers_SetsOnCodeDocument()
        {
            ...
            // Act
            var codeDocument = projectEngine.ProcessDesignTime(projectItem, tagHelpers: null);
